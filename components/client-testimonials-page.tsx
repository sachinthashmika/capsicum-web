    ...
    <div className="relative bg-[#262626] text-white overflow-hidden">
      ...
      <section className="relative z-10 py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-[28px] sm:text-[32px] md:text-[48px] leading-tight font-extrabold tracking-tight uppercase text-center mb-8">
            Clients Portfolio
          </h1>
