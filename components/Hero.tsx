...
export default function Hero() {
  return (
    <section id="home" className="relative w-full h-[calc(100vh-80px)] bg-gradient-to-br from-[var(--color-dark-bg)] via-[var(--color-dark-bg)] to-[var(--color-dark-gradient)] text-white overflow-hidden">

<LayoutWrapper className="h-full flex flex-col items-center justify-center gap-8 md:flex-row md:gap-16 pt-20 md:pt-0">

        {/* Left: Text content */}
        <div className="w-full md:w-1/2 max-w-full md:max-w-xl space-y-6 z-10 text-center md:text-left px-4">
  ...
  <div className="hidden md:block h-[600px] w-full max-w-[500px] -translate-y-5">
    <BellPepperOrbit />
  </div>
</div>
